...
export const useIsismapStore = defineStore('isismap', {
  state: () => ({
    ...
    creneaux: [
      { id: 1, id_salle: 'B108', id_prom: 'FIE4', enseignant: 'Mme Champ', debut: '2026-01-20T08:15:00', fin: '2026-01-20T10:15:00' },
      { id: 2, id_salle: 'B011', id_prom: 'FIE1', enseignant: 'Mr Singer', debut: '2026-01-20T10:30:00', fin: '2026-01-20T12:30:00' }
    ]
  })
})